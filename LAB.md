...
## Before you begin  
[x] Create a new repository and copy the contents of this lab folder into it.  
[x] You'll need to initialize this folder as a new node module, install your dependencies, setup your npm script commands, and pull in your config files  
...
[x] Work in the `models` folder in the starter code  
[x] You will find the models (with empty methods) in the models folder  
